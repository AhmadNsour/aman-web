...
export function VerificationForm({ onNext, onBack }: VerificationFormProps) {
  return (
    <section className="space-y-6">
      <div>
        <p className="text-xs font-semibold uppercase tracking-wider text-purple-600">Step 2 · Driver Verification</p>
        <h2 className="mt-2 text-2xl font-bold sm:text-3xl">Upload your documents</h2>
        <p className="mt-2 text-sm text-gray-600">These documents help us verify your identity and eligibility to drive with Aman.</p>
      </div>
